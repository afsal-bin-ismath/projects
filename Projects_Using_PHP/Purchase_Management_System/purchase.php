...
<header>
    ...
    if(isset($_POST['submit'])) {
        ...
        $supplier=$_POST['selSupp'];
        $qty=$_POST['txtq'];
        $price=$_POST['txtp'];
        $gstNo=$_POST['gst'];
     
        $sql="INSERT INTO purchase(Date,InvoiceNo,Medicine,Supplier,Qty,Price,GSTNo) VALUES ('$date','$invoice','$medicine','$supplier','$qty','$price','$gstNo')";
